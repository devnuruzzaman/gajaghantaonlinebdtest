            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.customers.update', $customer) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="connection_date" name="connection_date" value="{{ old('connection_date', $customer->connection_date?->format('Y-m-d') : '') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="expiry_date">Expiry Date</label>
                                <input type="date" class="form-control" id="expiry_date" name="expiry_date" value="{{ old('expiry_date', $customer->expiry_date?->format('Y-m-d') : '') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="monthly_fee" name="monthly_fee" value="{{ old('monthly_fee', $customer->monthly_fee) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('admin.customers.show', $customer) }}" class="btn btn-default">
